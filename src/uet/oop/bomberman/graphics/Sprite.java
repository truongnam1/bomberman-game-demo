...
public class Sprite {
	...
	public static Image wall1 = new Image("/sprites/wall.png", Sprite.SCALED_SIZE, Sprite.SCALED_SIZE, false, false);
	public static Image grass1 = new Image("/sprites/grass.png",Sprite.SCALED_SIZE, Sprite.SCALED_SIZE, false, false);
	public static Image brick1 = new Image("/sprites/brick.png",Sprite.SCALED_SIZE, Sprite.SCALED_SIZE, false, false);
	public static Image player_right1 = new Image("/sprites/player_right_1.png",Sprite.SCALED_SIZE - 1, Sprite.SCALED_SIZE - 1, false, false);
	public static Image player_left1 = new Image("/sprites/player_left_1.png",Sprite.SCALED_SIZE - 1, Sprite.SCALED_SIZE - 1, false, false);
	public static Image player_up1 = new Image("/sprites/player_up_1.png",Sprite.SCALED_SIZE - 1, Sprite.SCALED_SIZE - 1, false, false);
	public static Image player_down1 = new Image("/sprites/player_down_1.png",Sprite.SCALED_SIZE - 1, Sprite.SCALED_SIZE - 1, false, false);
